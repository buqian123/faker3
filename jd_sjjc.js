...
[task_local]
#手机竞猜
0 0 * * * https://raw.githubusercontent.com/Ari123szy/Private-Script/master/JD/zy_sjjc.js, tag= 手机竞猜
================Loon==============
[Script]
cron "0 0 * * *" script-path= https://raw.githubusercontent.com/Ari123szy/Private-Script/master/JD/zy_sjjc.js,tag= 手机竞猜
===============Surge=================
手机竞猜 = type=cron,cronexp="0 0 * * *",wake-system=1,timeout=3600,script-path= https://raw.githubusercontent.com/Ari123szy/Private-Script/master/JD/zy_sjjc.js
============小火箭=========
sjjc = type=cron,script-path= https://raw.githubusercontent.com/Ari123szy/Private-Script/master/JD/zy_sjjc.js, cronexpr="0 0 * * *", timeout=3600, enable=true
*/
const Ari123szy = '手机竞猜'
const $ = Env(Ari123szy)
...
async function readShareCodes(){
  return new Promise((resolve) => {
    let url = {
   		url: `https://raw.githubusercontent.com/Ari123szy/TGBOT/main/sjjc.js`,       
   	}
