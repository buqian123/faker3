...
!(async () => {
  ...
  console.log('5G超级盲盒，可抽奖获得京豆，建议在凌晨0点时运行脚本，白天抽奖基本没有京豆，3小时运行一次收集热力值\n' +
      ...
      '更新时间：2021-8-8 19:00');
  $.http.get({url: 'https://purge.jsdelivr.net/gh/Aaron-lv123/updateTeam@master/shareCodes/jd_shareCodes.json'}).then((resp) => {}).catch((e) => console.log('刷新CDN异常', e));
  await $.wait(1000)
  await updateShareCodesCDN('https://cdn.jsdelivr.net/gh/Aaron-lv123/updateTeam@master/shareCodes/jd_shareCodes.json')
